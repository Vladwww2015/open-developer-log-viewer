    ...
    <div class="col-md-10">
        <div class="card card-primary">
            <div class="card-header with-border">
                <button type="button" class="btn btn-primary btn-sm log-refresh"><i class="icon-refresh"></i> {{ trans('developer.refresh') }}</button>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach($logs as $index => $log)
                            <tr>
                                <td><span class="badge bg-{{\OpenDeveloper\Developer\LogViewer\LogViewer::$levelColors[$log['level']]}}">{{ $log['level'] }}</span></td>
...
<script data-exec-on-popstate>
    ...
    (function () {
        ...
        function fetch() {
            var url = '{{ $tailPath }}';
            var data = {offset : pos}
            developer.ajax.get(url,data,function(response){
